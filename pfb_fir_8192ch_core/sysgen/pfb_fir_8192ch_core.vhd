...
begin
  ...
  counter : entity xil_defaultlib.sysgen_counter_aac6c8a472 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant_x0 : entity xil_defaultlib.sysgen_constant_a08d884c70 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_945dec4b17 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_5b7917c701 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational : entity xil_defaultlib.sysgen_relational_2b543d8433 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_6edf461f73 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  counter : entity xil_defaultlib.pfb_fir_8192ch_core_xlcounter_free 
  generic map (
    core_name0 => "pfb_fir_8192ch_core_c_counter_binary_v12_0_i2",
    op_arith => xlUnsigned,
    op_width => 14
  )
  port map (

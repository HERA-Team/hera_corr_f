...
function fft_8192_1a_core_config(this_block)
  ...
  this_block.setEntityName('fft_8192_1a_core_ip_struct');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol0_in2').width ~= 12);
      this_block.setError('Input data type for port "pol0_in2" must have width=12.');
    end
    if (this_block.port('pol0_in3').width ~= 12);
      this_block.setError('Input data type for port "pol0_in3" must have width=12.');
    end
    if (this_block.port('pol0_in4').width ~= 12);
      this_block.setError('Input data type for port "pol0_in4" must have width=12.');
    end
    if (this_block.port('pol0_in5').width ~= 12);
      this_block.setError('Input data type for port "pol0_in5" must have width=12.');
    end
    if (this_block.port('pol0_in6').width ~= 12);
      this_block.setError('Input data type for port "pol0_in6" must have width=12.');
    end
    if (this_block.port('pol0_in7').width ~= 12);
      this_block.setError('Input data type for port "pol0_in7" must have width=12.');
    end
    if (this_block.port('pol0_in8').width ~= 12);
      this_block.setError('Input data type for port "pol0_in8" must have width=12.');
    end
    if (this_block.port('pol0_in9').width ~= 12);
      this_block.setError('Input data type for port "pol0_in9" must have width=12.');
    end
    if (this_block.port('pol0_in10').width ~= 12);
      this_block.setError('Input data type for port "pol0_in10" must have width=12.');
    end
    if (this_block.port('pol0_in11').width ~= 12);
      this_block.setError('Input data type for port "pol0_in11" must have width=12.');
    end
    if (this_block.port('pol0_in12').width ~= 12);
      this_block.setError('Input data type for port "pol0_in12" must have width=12.');
    end
    if (this_block.port('pol0_in13').width ~= 12);
      this_block.setError('Input data type for port "pol0_in13" must have width=12.');
    end
    if (this_block.port('pol0_in14').width ~= 12);
      this_block.setError('Input data type for port "pol0_in14" must have width=12.');
    end
    if (this_block.port('pol0_in15').width ~= 12);
      this_block.setError('Input data type for port "pol0_in15" must have width=12.');
    end

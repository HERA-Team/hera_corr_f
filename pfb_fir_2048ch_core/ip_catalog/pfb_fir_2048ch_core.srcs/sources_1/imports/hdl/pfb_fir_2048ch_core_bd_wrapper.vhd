...
--Command     : generate_target pfb_fir_2048ch_core_bd_wrapper.bd
--Design      : pfb_fir_2048ch_core_bd_wrapper
...
entity pfb_fir_2048ch_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end pfb_fir_2048ch_core_bd_wrapper;

architecture STRUCTURE of pfb_fir_2048ch_core_bd_wrapper is
  component pfb_fir_2048ch_core_bd is
  port (
    clk : in STD_LOGIC;
    pol0_in0 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    pol0_in1 : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component pfb_fir_2048ch_core_bd;
begin
pfb_fir_2048ch_core_bd_i: component pfb_fir_2048ch_core_bd
    port map (
      clk => clk,

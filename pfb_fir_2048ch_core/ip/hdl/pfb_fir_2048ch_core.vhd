...
begin
  ...
  generic map (
    core_name0 => "pfb_fir_2048ch_core_c_counter_binary_v12_0_i0",
    op_arith => xlUnsigned,
    op_width => 13
  )
  port map (
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i0",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i1",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i2",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i3",
    latency => 2
  )
  port map (
    en => "1",
  ...
  fan_delay1 : entity xil_defaultlib.sysgen_delay_23489be6aa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fan_delay2 : entity xil_defaultlib.sysgen_delay_23489be6aa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fan_delay3 : entity xil_defaultlib.sysgen_delay_23489be6aa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fan_delay4 : entity xil_defaultlib.sysgen_delay_23489be6aa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  counter : entity xil_defaultlib.sysgen_counter_8efc7f6f97 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  generic map (
    c_address_width => 13,
    c_width => 16,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i4",
    latency => 2
  )
  port map (
    en => "1",
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant_x0 : entity xil_defaultlib.sysgen_constant_a478885a93 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_b6a4db1460 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_4fbda804f4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter : entity xil_defaultlib.pfb_fir_2048ch_core_xlcounter_free 
  generic map (
    core_name0 => "pfb_fir_2048ch_core_c_counter_binary_v12_0_i1",
    op_arith => xlUnsigned,
    op_width => 14
  )
  port map (
  ...
  relational : entity xil_defaultlib.sysgen_relational_3ce5a50478 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_b70e9bbf6e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  generic map (
    ...
    c_latency => 1,
    c_output_width => 27,
    core_name0 => "pfb_fir_2048ch_core_c_addsub_v12_0_i0",
    extra_registers => 1,
    full_s_arith => 2,
    full_s_width => 27,
    latency => 2,
...
begin
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i5",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i6",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i7",
    latency => 2
  )
  port map (
    en => "1",
  ...
  generic map (
    c_address_width => 13,
    c_width => 18,
    core_name0 => "pfb_fir_2048ch_core_blk_mem_gen_v8_3_i8",
    latency => 2
  )
  port map (
    en => "1",

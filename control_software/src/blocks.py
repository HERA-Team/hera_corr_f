...
class Pam(Block):
    ...
    def get_attenuation(self):
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C attenuator')
            return None,None
    ...
    def set_attenuation(self, east=None, north=None):
        ...
        try:
            ...
            self.logger.warning('Failed to write I2C attenuator')
    ...
    def shunt(self, name='i'):
        ...
        if not hasattr(self, "_cur"):
            try:
                ...
                self.logger.warning("Failed to initialize I2C PAM current sensor")
                return None
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C PAM current sensor')
            del self._cur
            return None
    ...
    def id(self):
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C ID chip')
            return None
    ...
    def power(self, name='east'):
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C power sensor')
            del self._pow
            return None
    ...
    def rom(self, string=None):
        ...
        try:
            ...
            self.logger.warning('Failed to operate I2C ROM')
            return None
...
class Fem(Block):
    ...
    def pressure(self):
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C barometer')
            del self._bar
            return None
    ...
    def shunt(self, name='i'):
        ...
        if not hasattr(self, "_cur"):
            try:
                ...
                self.logger.warning("Failed to initialize I2C FEM current sensor")
                return None
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C FEM current sensor')
            del self._cur
            return None
    ...
    def id(self):
        ...
        try:
            ...
            self.logger.warning('Failed to read ID from I2C temperature sensor')
    ...
    def imu(self):
        ...
        try:
            ...
            self.logger.warning('Failed to read I2C IMU')
            del self._imu
            return None,None
    ...
    def rom(self, string=None):
        ...
        if not hasattr(self, "_rom"):
            try:
                ...
                self.logger.warning("Failed to initialize FEM I2C ROM")
                return None
        ...
        try:
            ...
            self.logger.warning("Failed to operate FEM I2C ROM")
            return None
    ...
    def switch(self,name=None):
        ...
        try:
            ...
            self.logger.warning("Failed to operate I2C RF switch")
            return None
    ...
    def temperature(self):
        ...
        try:
            ...
            self.logger.warning("Failed to read I2C temperature sensor")
            return None

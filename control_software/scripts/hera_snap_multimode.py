...
import argparse
from hera_corr_f import SnapFengine, HeraCorrelator, __version__
...
parser = argparse.ArgumentParser(description='Set a programmed SNAP board to send data as '
                                             'arbitrary number of antennas in the test vector '
